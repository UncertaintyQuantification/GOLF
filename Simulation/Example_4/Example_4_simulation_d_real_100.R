...
kernal = 'matern_5_2' #c('matern_5_2', 'exp')
...
items = data.frame(kernal, missing_per, missing_pattern)
...
kernel_type=as.character(items$kernal)
...
#save(missing_index, separable_truth_data_all, separable_full_data_all, file="All_Separable_Data_March_5.RData")

#save(missing_index, nonseparable_truth_data_all, nonseparable_full_data_all, file="All_Nonseparable_Data_March_5.RData")
...
save(record_nonseparable_error, record_separable_error, return_list_separable_record,return_list_nonseparable_record, file=paste0("separable_prediction_d_real_",d_real,"_d_",d,".Rdata"))

#save(record_nonseparable_error, record_separable_error, return_list_separable_record,return_list_nonseparable_record, file="separable_prediction_d_real_30_d_5.Rdata")
...
record_simulation_time=system.time(
  for(i_M in 1:num_simulation){
    ##make data
    print(i_M)
    Y_full=as.matrix(nonseparable_full_data_all[i_M,],n1,n2)
    Y_truth=as.matrix(nonseparable_truth_data_all[i_M,],n1,n2)
    Y=matrix(NA,n1,n2)
    Y[-missing_index]=Y_full[-missing_index]
    #image2D((Y),input1,input2)
    missing_index_all=missing_index
...
save(record_nonseparable_error, record_separable_error, return_list_separable_record,return_list_nonseparable_record, file=paste0("nonseparable_prediction_d_real_",d_real,"_d_",d,".Rdata"))
